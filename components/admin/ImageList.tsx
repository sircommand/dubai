      ...
      <div className="p-6 border-b border-slate-200 dark:border-slate-800 flex justify-between items-center">
        ...
        <div className="relative">
          ...
          <input
            ...
            className="pl-9 pr-4 py-1.5 text-sm rounded-full border-slate-200 dark:border-slate-700 dark:bg-slate-800 focus:ring-primary focus:border-primary outline-none"
          />
        </div>
      </div>
