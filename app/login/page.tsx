...
export default function LoginPage() {
  ...
  return (
    <>
      ...
      <div className={`min-h-screen flex items-center justify-center ${isDark ? 'dark' : ''} bg-background-light dark:bg-background-dark transition-colors duration-200`}>
        <div className="w-full max-w-md px-6">
          ...
          <button
            ...
            className="mx-auto mt-6 p-2 rounded-full hover:bg-slate-200 dark:hover:bg-slate-800 text-slate-600 dark:text-slate-400 transition-colors"
          >
